            ...
            <div>
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="container mx-auto lg:w-3/4 md:w-4/5 sm:w-full px-5 py-24">
                            <h1 class="title-font font-medium text-3xl text-gray-900">Book your Trip now!</h1>
                        ...
                        <div class="container mx-auto lg:w-3/4 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full">
                            <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Add Flight</h2>
                            ...
                            <div class="relative mb-4">
                                <label for="Departure Time" class="leading-7 text-sm text-gray-600">Departure Time</label>
                                <input
                                    type="time"
                                    id="depTime"
                                    name="depTime"
                            ...
                            <div class="relative mb-4">
                                <label for="Arrival Time" class="leading-7 text-sm text-gray-600">Arrival Time</label>
                                <input
                                    type="time"
                                    id="arrTime"
                                    name="arrTime"
                            ...
                            <button
                                class="text-white bg-indigo-500 border-0 py-2 px-20 focus:outline-none hover:bg-indigo-600 rounded text-lg"
                                onClick={handleClick}>
                                Add Flight
                            </button>
                        </div>
