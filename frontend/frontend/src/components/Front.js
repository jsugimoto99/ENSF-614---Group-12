      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 mx-auto">
          <div class="flex flex-wrap w-full mb-20">
            ...
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500 animate__backInDown">
              Always book with us for the best experience
            </p>
          </div>
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
                ...
                <p class="leading-relaxed text-base">
                  our safety is our top priority, and we want to ensure you have
                  a smooth and secure journey with us. Here are some important
